...
def artifactSpot(seed,day,x,y,location):
    ...
    r = CSRandomLite(x*2000+y+int(seed/2) + day)
...
if __name__ == '__main__':
    ...
    for x in range(10):
        for y in range(10):
            item = artifactSpot(55807,1,x,y,"Mountain")
